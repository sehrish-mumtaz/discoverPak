...
!pip install --upgrade httpx pandas streamlit requests googletrans==4.0.0-rc1 folium streamlit-folium
...
with st.expander("Help", expanded=False):
    ...
    st.write("3. **Language Support:** Responses available in Urdu.")
    st.write("4. **Weather Updates:** Current weather information for regions.")
    st.write("5. **Local Events:** Information on upcoming events and activities.")
    st.write("6. **Travel Tips:** Advice on safety, cultural etiquette, and more.")
    st.write("7. **Feedback and Queries:** Share your feedback or ask additional questions.")
